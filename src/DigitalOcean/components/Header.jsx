...
const Header = () => {
    ...
    return (
        <div>
            <header className="py-4 shadow-md z-40 fixed w-full bg-white xl:hidden block">
                <div className="container mx-auto flex justify-between font-inter lg:px-10 2xl:px-24 px-4">
                    ...
                    <div className="flex">
                        ...
                        <div className="border-l-2 mr-5 hidden sm:block"></div>
                        <div className="cursor-pointer" onClick={toggleHamburgerMenu}>
                            <div className={`flex items-center h-full ${isHamburgerOpen ? 'hidden' : 'show'}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9h16.5m-16.5 6.75h16.5" />
                                </svg>
                            </div>
                            <div className={`flex items-center h-full ${isHamburgerOpen ? 'show' : 'hidden'}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
            ...
            <header className="py-4 shadow-md z-40 fixed w-full bg-white mt-10 hidden xl:block">
                <div className="container mx-auto flex justify-between font-inter lg:px-10 2xl:px-24 px-4">
                        ...
                        <nav>
                            <ul className="flex gap-x-1 pl-10 items-center font-medium">
                                <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuProducts}>Products<li>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isProductsOpen ? 'rotate-180' : null}`}>
                                ...
                                <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuSolutions}>Solutions<li>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isSolutionsOpen ? 'rotate-180' : null}`}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </li></a>
                                <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuDevelopers}>Developers<li>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isDevelopersOpen ? 'rotate-180' : null}`}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </li></a>
                                <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuBusinesses}>Businesses<li>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isBusinessesOpen ? 'rotate-180' : null}`}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </li></a>
            ...
            <div className="xl:hidden block">
                <div className={`${isHamburgerOpen ? 'show' : 'hidden'}`}>
                    <HamburgerMenu />
                </div>
            </div>
        </div>
