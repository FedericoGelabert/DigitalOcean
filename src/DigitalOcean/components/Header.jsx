...
import DropDownMenuDevelopers from "./DropDownMenuDevelopers";
import DropDownMenuBusinesses from "./DropDownMenuBusinesses";

const DDMenuProducts = document.getElementById('DDMenuProducts')
console.log(DDMenuProducts)
...
const Header = () => {
    ...
    function toggleMenuDevelopers() {
        setIsDevelopersOpen(!isDevelopersOpen)
        setIsProductsOpen(false)
        setIsSolutionsOpen(false)
        setIsBusinessesOpen(false)
    }
    function toggleMenuBusinesses() {
    ...
    return (
        <header className="py-4 shadow-md z-20 fixed w-full bg-white mt-10">
            <div className="container mx-auto flex justify-between font-inter">
                <div className="flex items-center">
                    ...
                    <nav>
                        ...
                        <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuProducts}>Products<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isProductsOpen ? 'rotate-180': null}`}>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
                            <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuSolutions}>Solutions<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isSolutionsOpen ? 'rotate-180': null}`}>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
                            <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuDevelopers}>Developers<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isDevelopersOpen ? 'rotate-180': null}`}>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
                            <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl" onClick={toggleMenuBusinesses}>Businesses<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={`w-4 h-4 text-gray-600 ${isBusinessesOpen ? 'rotate-180': null}`}>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
                            <a href="#" className="hover:bg-gray-200 p-3 rounded-xl"><li>Pricing</li></a>
                        </ul>
                    </nav>
                </div>
            ...
            <div className={isProductsOpen ? 'show': 'hidden'}>
                <DropDownMenuProducts />
            </div>
            <div className={isSolutionsOpen ? 'show': 'hidden'}>
                <DropDownMenuSolutions />
            </div>
            <div className={isDevelopersOpen ? 'show': 'hidden'}>
                <DropDownMenuDevelopers />
            </div>
            <div className={isBusinessesOpen ? 'show': 'hidden'}>
                <DropDownMenuBusinesses />
            </div>
        </header>
    )
}
