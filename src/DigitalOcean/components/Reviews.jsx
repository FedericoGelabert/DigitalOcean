        ...
        <div className="relative">
            ...
            <div className="bg-do-reviews">
                <div className="container mx-auto relative xl:px-28 px-4">
                    <img src="https://www.digitalocean.com/_next/static/media/garnish-blue.26799a4e.svg" alt="Granish blue" className="absolute z-10 xl:top-24 top-36 xl:left-36 hidden md:block"/>
                    <img src="https://www.digitalocean.com/_next/static/media/garnish-2-blue.5aa0f894.svg" alt="Granish2 blue" className="absolute z-30 lg:top-40 top-180 first-letter:xl:right-24 right-10 hidden md:block"/>
                    ...
                    <div className="flex justify-center md:py-20 py-20 pt-0 lg:flex-row flex-col gap-y-8 lg:gap-y-0 items-center">
                        ...
                        <div className="relative lg:right-16 right-0 ">
                            <img src="https://www.digitalocean.com/_next/static/media/h-grant-designs-card.4c8bc703.png" alt="" className="xl:h-96 rounded-3xl"/>
                        </div>
                    </div>
                </div>
            </div>
