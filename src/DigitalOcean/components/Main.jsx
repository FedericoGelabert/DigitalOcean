...
const Main = () => {
    return (
        <div className="pt-28">
            <div className="pt-32 bg-do-blue-light bg-main-image bg-cover rounded-b-main h-200 relative z-10">
                <div className="container mx-auto flex items-center flex-col text-white">
                    ...
                    <p className="mt-5 text-center font-inter text-xl w-4/6">Whatever your vision—a SaaS app, an AI/ML business, a website, an eCommerce store— build it here
                        using DigitalOcean's simple, cost-effective cloud hosting services.</p>
                    <div className="mt-8 font-semibold flex gap-x-5 font-inter">
                        <button className="px-5 py-2 rounded-lg bg-do-blue-mediumdark hover:bg-do-blue-bhover hover:duration-300">Sign up with email</button>
                ...
                <div className="container mx-auto flex justify-center mt-16">
                    <img alt="Preview of the DigitalOcean Control Panel " src="https://www.digitalocean.com/_next/static/media/dashboardMockup.2c5abdba.svg" className="rounded-xl w-8/12 shadow-2xl"></img>
                </div>
                <div className="flex container mx-auto gap-20 justify-center mt-10 font-inter">
                    <div className="w-64">
