    ...
    return (
        <div className="py-6 shadow-md">
            <div className="container mx-auto flex justify-between">
                ...
                <div className="gap-6 flex font-semibold">
                    <button className="bg-white-400 py-2 px-3 rounded-xl">Log in</button>
                    <button className="bg-do-blue-light py-2 px-4 border rounded-xl text-white">Sign up</button>
                </div>
            </div>
        </div>
    )
