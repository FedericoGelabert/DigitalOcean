...
const Header = () => {
    return (
        <header className="py-4 shadow-md z-30 fixed w-full bg-white mt-10">
                ...
                <div className="flex items-center">
                    ...
                    <nav>
                        ...
                        <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl">Products<li>
                            ...
                            <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl">Solutions<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 text-gray-600">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
                            <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl">Developers<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 text-gray-600">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
                            <a href="#" className="flex items-center gap-2.5 hover:bg-gray-200 p-3 rounded-xl">Businesses<li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 text-gray-600">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                </svg>
                            </li></a>
